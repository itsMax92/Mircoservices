...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleGlobalException(CustomerAlreadyExistsException customerAlreadyExistsException,
                                                                                 WebRequest webRequest) {
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(webRequest.getDescription(false),
                HttpStatus.INTERNAL_SERVER_ERROR, customerAlreadyExistsException.getMessage(), LocalDateTime.now());
